...
# “push” or apply the changes to the repo (if you are using the main branch
# you will type master instead of branchname)
...
# Automatically move to "Choose date range" tab #39


# to avoid .ignore being tracked
git rm -r --cached .ignore
git commit -m "Stop tracking .ignore"
