...
testthat::test_path()
testthat::test_local(testthat::test_path())
testthat::test_file(testthat::test_path("test_metamet_read.R"))
testthat::test_file(testthat::test_path("test_metamet_read_amo.R"))
testthat::test_file(testthat::test_path("test_metamet_read_buc.R"))
...
testthat::test_file(testthat::test_path("test_metamet_read_qc.R"))
