...
The simplest function is simply to create a network map with the
...
We can also create interactive polar plot maps using
[`polar_map()`](https://nerc-ceh.github.io/metamet/reference/polar_map.md).
The function extracts the appropriate time, wind speed, and wind
direction fields from a metamet object, and produces a leaflet-based
